      ...
      <Container>
        ...
        <Row>
          ...
          <ul>
            ...
            <li>Resume and job-related information (for career services)</li>
          </ul>
          <p>
            I may also collect non-personal information strictly for the
            purposes of analyzing trends and improving my website. The types of
            information that may be collected in this way include but are not
            limited to:
          </p>
          <ul>
            <li>IP address</li>
          ...
          <h5>Use of Data</h5>
          <p>I use the collected data for the following purposes:</p>
          <ul>
          ...
          <p>
            ...
            provide you with my services. I will never sell, rent, lease, or buy
            your data.
          </p>
          ...
          <p>
            ...
            or my use of your personal information, please contact me at
            welcomefinancialco@gmail.com.
          </p>
          <h5>Children's Online Privacy Protection</h5>
          <p>
            My services are not intended for children under 18. I do not
            knowingly collect information from children. By using my website and
